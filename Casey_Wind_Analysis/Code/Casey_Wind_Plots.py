...
from Wind_Data import df_avg_year, df_avg_day_by_month, avg_wspd, avg_wdir, avg_temp, avg_prcp, avg_pres
...
fig1.suptitle("Casey Station (89611) — Wind Analysis", fontsize=14, fontweight='bold')
...
fig2.suptitle("Casey Station (89611) — Climate Analysis", fontsize=14, fontweight='bold')
